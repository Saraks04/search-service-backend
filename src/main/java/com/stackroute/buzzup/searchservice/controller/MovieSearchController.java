...
public class MovieSearchController 
{
	...
	/*
	 * The below handler method is mapped to the URL "/api/v1/city" inorder to save the city details.
	 * It must return any one of the status messages based on the the retrieved result:
	 * 1.201(CREATED) - If the city is found         
	 */
	...
	/*
	 * The below handler method is mapped to the URL "/api/v1/city/{cityName}" in order
